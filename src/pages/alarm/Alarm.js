...
const data = [
  { id: 1, content: "고든램지 버거 예약 완료", datetime: "2022.00.00(월) 00:00", people: "성인 0명" },
  { id: 2, content: "고든램지 버거 입장 안내", datetime: "2022.00.00(월) 00:00", people: "성인 0명" },
  { id: 3, content: "고든램지 버거 원격 웨이팅 등록", datetime: "2022.00.00(월) 00:00", people: "성인 0명" },
];
  ...
  <tr key={item.id}>
    <td className="Alarm-List-Item">
      ...
      <div className="Alarm-List-Item-body">
        ...
        <div className="Alarm-List-Item-foot">{item.datetime} {item.people}</div>
      </div>
    </td>
  </tr>
));
